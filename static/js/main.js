(function($) {
  ...
  "retina_detect": true
    ...
    var countDownDate = new Date("Oct 6, 2017 15:00:00 GMT+09:00").getTime();
    ...
    var x = setInterval(function() {
      ...
      document.getElementById("demo").innerHTML = "5% Bonus Period ends in: " + days + "d " + hours + "h "
      + minutes + "m " + seconds + "s ";
